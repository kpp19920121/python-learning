...
openAIclient = OpenAI(api_key=open_api_key,base_url="https://qianfan.baidubce.com/v2")

chatCompletion = openAIclient.chat.completions.create(model="deepseek-v3", messages=[
